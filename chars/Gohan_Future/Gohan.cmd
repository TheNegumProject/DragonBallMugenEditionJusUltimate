...
type = ChangeState
Triggerall = var(2) = 0
Triggerall = ifelse(var(3) = 1,power >= 1500,power >= 1000)
value = 1100
...
trigger2 = numhelper(700) > 0
;---------------------------------------------------------------------------
; Super Ultimate Masenko
[State -1, Super Ultimate Masenko]
type = ChangeState
Triggerall = var(2) = 1
Triggerall = power >= 1000
value = 25200
...
Triggerall = var(2) = 1
Triggerall = power >= 1500
value = ifelse(pos y < 0,1580,1500)
